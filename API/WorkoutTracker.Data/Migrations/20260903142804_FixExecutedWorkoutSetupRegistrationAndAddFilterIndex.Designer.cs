...
namespace WorkoutTracker.Data.Migrations
{
    ...
    [Migration("20260903142804_FixExecutedWorkoutSetupRegistrationAndAddFilterIndex")]
    partial class FixExecutedWorkoutSetupRegistrationAndAddFilterIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkoutTracker.Domain.Users.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorkoutTracker.Domain.Workouts.Workout", b =>
                {
                    ...
                    b.HasIndex("CreatedByUserId", "Active", "Name");
            ...
            modelBuilder.Entity("WorkoutTracker.Domain.Users.RefreshToken", b =>
                {
                    b.HasOne("WorkoutTracker.Domain.Users.RefreshToken", "ReplacedByToken")
                        .WithMany()
                        .HasForeignKey("ReplacedByTokenId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("WorkoutTracker.Domain.Users.User", "User")
                        .WithMany()
