...
class WorkoutServiceMock {
    ...
    add = vi.fn().mockReturnValue(of(new Workout()));
    update = vi.fn().mockReturnValue(of(new Workout()));
}
...
describe('WorkoutEditComponent', () => {
    ...
    it('should get create form during init', () => {
        ...
        expect(component.workoutForm.controls.id.hasValidator(Validators.required)).toBe(true);
        expect(component.workoutForm.controls.active).not.toBeNull();
        expect(component.workoutForm.controls.active.hasValidator(Validators.required)).toBe(true);
        expect(component.workoutForm.controls.name).not.toBeNull();
        expect(component.workoutForm.controls.name.hasValidator(Validators.required)).toBe(true);
    ...
    it('should load workout based on route param ID during init', () => {
        ...
        expect(component.workoutForm.controls.active.value).toBe(true);
    ...
    */
    ...
    it('should add a new workout', () => {
        ...
        expect(component.workoutForm.invalid).toBe(false);
    ...
    it('should not save a workout if the form is invalid', () => {
        ...
        expect(component.workoutForm.invalid).toBe(true);
    });
