...
export class ResistanceTypePipe implements PipeTransform {
  ...
  transform(value: ResistanceType | number | undefined, capitalizeEachWord: boolean = true): string {
